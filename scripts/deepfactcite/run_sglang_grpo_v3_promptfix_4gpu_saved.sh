...
export RUN_TAG="${RUN_TAG:-20260518_v3_promptfix_4gpu_saved}"
export MODE="${MODE:-citation-aware}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-dfc-mixclean200-v3-promptfix-onecite-20260518_4gpu_saved}"
...
export GRPO_REQUIRE_FINAL_CHECKPOINT="${GRPO_REQUIRE_FINAL_CHECKPOINT:-1}"
...
export GRPO_GPU_MEMORY_UTILIZATION="${GRPO_GPU_MEMORY_UTILIZATION:-0.20}"
